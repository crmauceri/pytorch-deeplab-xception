...
# From https://github.com/laughtervv/DepthAwareCNN
...
class VGG(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.features = VGG_layer(batch_norm=cfg.MODEL.VGG16.DEPTH_CONV,depthconv=cfg.MODEL.VGG16.DEPTH_CONV)
        self.classifier = Classifier_Module2(cfg.DATASET.N_CLASSES,512,depthconv=cfg.MODEL.VGG16.DEPTH_CONV)
...
if __name__ == "__main__":
    ...
    target = torch.randint(0, 19, (1, 64,64)) #torch.ones((19*64*64), dtype=torch.long)
